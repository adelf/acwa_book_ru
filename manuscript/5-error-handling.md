...
Как только конструктор вышего класса вырастает так, что вызовы new этого класса выглядят коряво, задумайтесь об именованных конструкторах для него.
...
В новых версиях Laravel глобальные обработчики имеют несколько другой формат, но смысл остался прежним.

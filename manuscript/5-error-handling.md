...
A> Каждый заслуживает третий шанс!
...
Прекрасно. Бизнес-логика уехала из контроллера в сервисный класс. Валидация в FormRequest-объект. Обработка исключений в глобальный обработчик. Контроллеру осталось лишь контролировать процесс на самом высоком уровне. Наконец-то, его работа соответствует названию!
...
Единственное, что он может сделать, это показать пользователю сообщение "Произошло что-то плохое и я не знаю, что с этим делать".

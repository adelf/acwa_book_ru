...
Когда я отрефакторил этот метод созданием разных методов **create** и **update** и выносом общей логики в нужные методы и классы, код стал в разы проще для чтения.

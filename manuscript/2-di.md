...
Представим простое приложение, представляющее собой простые списки сущностей с возможностью создавать их, изменять и удалять, так называемое CRUD-приложение.
...
Я привёл этот пример, потому что я часто встречаю такое вынесение функционала, захватывающее слишком многое.
...
Я приведу наполовину синтетический пример, который покажет насколько опасно использовать наследование подобный образом.
